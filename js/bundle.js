...
/***/ function(module, exports, __webpack_require__) {
	...
	var StateExample = __webpack_require__(170);
	...
	ReactDOM.render(React.createElement(StateExample, {food: food}), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StateExample = React.createClass({displayName: "StateExample",
	  getInitialState: function () {
	    return {
	  ...
	  render: function () {
	    ...
	    return (
	      React.createElement("div", null, 
	        React.createElement("input", {type: "text", onChange: this._handleChange, value: this.state.txt}), React.createElement("br", null), 
	        React.createElement("img", {onClick: this._handleImgClick, src: "/images/" + this.state.img + ".jpeg"})
	      )
	    )
	  }
	});
